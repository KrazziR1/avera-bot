...
async def build_flip_panel_embeds():
    ...
    FOOTER     = f"📡 prices.runescape.wiki  •  🕐 Last updated: <t:{unix_now}:R>"
    now        = datetime.now()
    ...
    return margins_embed, hv_embed, up_embed, down_embed, guide_embed
...
async def flip_panel_refresh():
    ...
    margins_embed, hv_embed, up_embed, down_embed, guide_embed = await build_flip_panel_embeds()
    ...
    g_msg    = await channel.send(embed=guide_embed)
