    ...
    if channel:
        embed = discord.Embed(
            ...
            description=(
                ...
                f"Use `!verify <username>` in <#{WELCOME_PANEL_CHANNEL_ID}> to link your OSRS account.\n\n"
                f"**2️⃣ Claim your rank**\n"
                f"Run `!rankcheck` after verifying — this assigns your Discord rank based on your in-game stats and shows your Glory progress.\n\n"
                f"**3️⃣ Read the FAQ**\n"
                f"Check <#{FAQ_CHANNEL_ID}> for everything you need to know about points, ranks, bounties, and more.\n\n"
                f"**4️⃣ Grab your roles**\n"
                f"Head to <#{REACTION_ROLES_CHANNEL_ID}> to set your account type, region, and raid groups.\n\n"
                f"**5️⃣ Check the bounties**\n"
                f"Browse active bounties in <#{BOUNTY_CHANNEL_ID}> — complete them to earn points and Glory!\n\n"
                f"**⚔️ In-game:** Join our clan CC — search **\"{CLAN_NAME}\"** in-game to find us!\n\n"
