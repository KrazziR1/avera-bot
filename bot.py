...
def load_data():
    ...
    global announced_milestones, dashboard_message_id, flip_panel_message_id, flip_hv_message_id, flip_up_message_id, flip_down_message_id, flip_guide_message_id, weekly_stats, flip_logs, ge_item_name_map, ge_item_limit_map
