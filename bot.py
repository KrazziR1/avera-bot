...
async def fetch_gear_image(wiki_name: str, style: str) -> tuple[bytes | None, str | None]:
    ...
    try:
        async with async_playwright() as p:
            ...
            # The equipment table is inside a section with heading "Equipment"
            equipment_section = None

            # Try to find the equipment table wrapper
            for selector in [
                "table.wikitable",
                ".wikitable",
                "table:has(th:has-text('Slot'))",
                "#Equipment ~ table",
                "h2:has-text('Equipment') ~ table",
                "h3:has-text('Equipment') ~ table",
            ]:
                try:
            ...
            if equipment_section is None:
                # Fall back to screenshotting the full content area
                equipment_section = page.locator("#mw-content-text").first
